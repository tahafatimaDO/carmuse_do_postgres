    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist_dates', wagtail.core.fields.StreamField([('dates', wagtail.core.blocks.StructBlock([('date_of_birth', wagtail.core.blocks.DateBlock()), ('date_of_death', wagtail.core.blocks.DateBlock())]))], blank=True, null=True)),
                ('bio', wagtail.core.fields.RichTextField(blank=True, null=True)),
                ('pitch', wagtail.core.fields.RichTextField(blank=True, null=True)),
                ...
                ('painter_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.Image')),
            ],
            options={
                'abstract': False,
            },
